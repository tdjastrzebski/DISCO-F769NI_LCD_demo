### This repo contains demo project for STM32F769 discovery kit with LCD support demonstrating how to program STM32F7 using open source, cross-platform tools only
